...
def save_figure(data, filename):
    #this unction converts all the signal to images
...
def segmentation(filename):
   #This function gets the ECG segment waves and creats as image
    ...
    save_figure(signals[0], '/'.join([folder, filename_new]))

if __name__ == '__main__':
    records = get_records('./ecg-id-database-1.0.0/*/*.atr') # to load the records from the path file.
